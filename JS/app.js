...
// console.log(cipher(wordPrompt,33));//llamas al cifrado


// creando decifrado
function decipher(word, displacement) {
  var writeWord = word.toUpperCase();// pasamos a mayusculas
  ...
  for (var j = 0; j < storesASCIIdecipher.length; j++) { // recorre los elementos de storesASCIIdecipher
    decipherCesar.push((storesASCIIdecipher[j] + 65 - displacement) % 26 + 65); // cifra y agrega elementos a decipherCesar
  }
...
console.log(decipher(wordPrompt, 33));// llamas al decifrado
